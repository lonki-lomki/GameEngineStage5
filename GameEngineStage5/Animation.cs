        ...
        public void update(int delta)
        {
            ...
            if (started == true)
            {
                ...
                if (frameTimeout <= 0)
                {
                    ...
                    {
                        // Воспроизведение анимации окончено
                        // Проверить флаг зацикливания
                        if (isLooped == true)
                        {
                            // Вернуться к первому кадру и запустить повторную анимацию
                            frameIndex = 0;
                            curFrame = frames[frameIndex];
                            frameTimeout += duration;
                        }
                        ...
                        {
                            // Зацикливания нет, остановить анимацию
                            started = false;
                        }
                    }
                }
